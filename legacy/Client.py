...
def OnClick():
    global HOST, PORT, CHANGENAME, NAME
    CHANGENAME = False
...
# Label[Host]
H_Label = tkinter.Label(F1, text='Enter Host <Default If No Input>', bg='black', fg='white')
H_Label.pack()
